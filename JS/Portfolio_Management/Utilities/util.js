...
class Utility{
  ...
  static AddEventListener(elementID,eventType,fnCallback){
    const control=document.getElementById(elementID);
    control.addEventListener(eventType,fnCallback)
  ...
  static FetchFormValues(form){
    ...
    const formElements=[...form.elements].filter(ele=>ele.type !== 'submit');/* 2. Use filter condition where element type is not submit */          
