...
for(const currSecurity of Securities){/* 1. Identify whether it should be in or of operator */
ClassifiedSecurities.push( new Security(currSecurity) );/* 2. You have to create an instance of class Security by using currSecurity*/
}
